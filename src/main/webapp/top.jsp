...
<body>
	...
	<form action="Login" method="post">
		...
		<a href="myBookmark.jsp" class="menu">マイページ</a> <a
			href="showRanking.jsp" class="menu">ランキング</a> <a
			href="importMusic.jsp" class="menu">曲追加</a> <a href="無記入"
			class="menu">ログアウト</a> <a href="deleteUser.jsp" class="menu">アカウント削除</a>
		</div>

		<div class="main">

			<%-- 検索バー --%>
			<divclass "search-area">
